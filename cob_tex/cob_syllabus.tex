...
\newcommand{\customhref}[2]{
	...
	%----- PROF CONFIG ------------------------
\newcommand{\semester}{SPRING SEMESTER, 2021}
\input{2021spr/cis48901}
...
\textbf{COVID-19 REQUIREMENTS:} \par
\begin{itemize}[topsep=-6pt]
\item Masks are required inside buildings, classrooms, and outside public spaces.
\item Do not congregate in groups in the hallways before classes begin.
\item All students are required to take the\customhref{https://una.co1.qualtrics.com/jfe/form/SV_0UIsIbwa0u7yRPn}{COVID-19 Self-Screening Assessment}and undergo daily self-temperature checks each morning before coming to campus or going to class. Upon completing the UNA Healthcheck, students are provided a daily Passport. You need to print off the passport each day and bring it to class, or have your smartphone with you that shows your green passport for that day. Faculty may require you to show them your Passport upon arriving to your class. To learn more about the passport, review the\customhref{https://www.una.edu/reopening/una-entry-to-campus-checklist.html}{UNA's Entry to Campus Checklist}.
\item Do not arrive for class until about 7 minutes before the class begins. This will allow enough time for the class before you to empty the classroom and keep the hallways less congested.
\item Faculty members have the option to have face-to-face or virtual office hours. If you are meeting with faculty members in their office, you must wear a mask.
\item Follow social distancing guidelines on campus.
\item If you are registered for face-to-face classes, most of these will be offered in a hybrid format. For hybrid delivery, you will be assigned specific days that you will be in the classroom and days you will participate remotely or online. Faculty members will let you know by Monday, August 17th the days you are assigned to be in the classroom.
\item Stairwells in Keller Hall will be one-way only. Note the signage as to whether the stairwell is for ``UP'' or ``DOWN''. Please stay to the right side of hallways in Keller and Raburn.
\item It is recommended that there be no eating at any time in a classroom to avoid all finger/hand-to-mouth contact, unless approved in advance by the instructor (e.g. a diabetic student might require food items). No food or drink is ever allowed in computer labs.
\item Most face-to-face classes in the College of Business will be recorded this semester, including class discussion between faculty members and students. The webcam will record the professor, not the students, but all audio will be recorded.
\end{itemize}
