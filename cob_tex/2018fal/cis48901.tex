...
\newcommand{\courseobjectives}{\item Explain interaction design techniques and the benefits of using interaction design principles for software development. (COB Goal 2)
	\item Expand the concept of traditional usability to a broader notion of user experience. (COB goal 3)
	\item Experience hands-on, practical team-work engaging in the process of the iterative evaluation-centered UX lifecycle. (COB goals 1 and 3)
	\item Embrace design thinking and ideation to address the new characteristics embodied within user experience
	\item Describe and experience agile UX development methods. (COB goals 1 and 3)
	\item Work in a team environment on a project using interaction design creation and refinement activities such as: (COB goals 1 and 3)
		\begin{enumerate}
