...
\newcommand{\courseobjectives}{\item Explain interaction design techniques and the benefits of using interaction design principles for software development. (COB Goal 2)
	\item Use best practices to design an effective interface. (COB Goal 2)
	\item Implement a well-designed interface. (COB Goal 2)
	\item Effectively evaluate an existing interface. (COB Goal 2)
}
...
\newcommand{\coursegrades}{Subject Exams (4 exams @ 15\% each)\dotfillsmall 60\% \\
		Projects\dotfillsmall 30\% \\
		Quiz Average\dotfillsmall 10\% }
